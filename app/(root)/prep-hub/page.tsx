                        ...
                        >
                            <div className="flex items-center justify-between px-6 py-6 flex-shrink-0" style={{ borderBottom: "1px solid rgba(99,102,241,0.1)" }}>
                                {sidebarOpen ? (
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-black uppercase tracking-[0.2em] text-indigo-600">History</span>
                                    </div>
                                ) : (
                                ...
                                <button
                                    ...
                                    className="flex h-8 w-8 items-center justify-center rounded-xl transition-all hover:bg-black/5"
                                    style={{ color: "#64748b" }}
                                >
                                    {sidebarOpen ? (
                            ...
                            <div className="flex-1 overflow-y-auto px-4 pb-6 flex flex-col gap-2" style={{ scrollbarWidth: "none" }}>
                                {sessions.length === 0 && sidebarOpen && (
                                    ...
                                    <div className="h-12 w-12 rounded-2xl bg-black/5 flex items-center justify-center mb-4" style={{ border: "1px dashed rgba(0, 0, 0,0.1)" }}>
                                        <File className="h-6 w-6 text-slate-600" />
                                    </div>
                                    <p className="text-xs font-black text-slate-600">No history yet.<br/>Start your first analysis.</p>
                                    </div>
                                )}
                                {sessions.map((s) => (
                                    <button
                                        ...
                                        style={{
                                            background: activeResult?.id === s.id 
                                                ? "rgba(99,102,241,0.1)" 
                                                : "transparent",
                                            border: `2px solid ${activeResult?.id === s.id ? "rgba(99,102,241,0.3)" : "rgba(0,0,0,0.1)"}`,
                                        }}
                                    >
                                        ...
                                        {sidebarOpen ? (
                                            <div className="flex flex-col gap-1.5">
                                                <div className="flex items-center gap-3">
                                                    <div className="h-8 w-8 rounded-lg flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110" 
                                                        style={{ background: activeResult?.id === s.id ? "rgba(99,102,241,0.2)" : "rgba(0, 0, 0,0.05)" }}>
                                                        <FileText className={`h-4 w-4 ${activeResult?.id === s.id ? "text-indigo-400" : "text-slate-600"}`} />
                                                    </div>
                                                    <span className="text-xs font-bold truncate flex-1" style={{ color: activeResult?.id === s.id ? "#0f172a" : "#475569" }}>
                                                        {shortName(s.fileName, 24)}
                                                    </span>
                                                </div>
                                                <div className="flex items-center justify-between pl-11 mt-0.5">
                                                    <span className="text-[10px] font-black text-slate-800">{formatDate(s.createdAt)}</span>
                                                    {s.hasJD && (
                                            ...
                                            <div className="flex justify-center h-8 items-center">
                                                <FileText className="h-5 w-5 text-slate-600 opacity-70 group-hover:opacity-100 transition-opacity" />
                                            </div>
                                        )}
                                    </button>
                                ))}
                                ...
                                <div className="rounded-[2.5rem] p-10 mb-8"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                        <div className="flex flex-col gap-3">
                                            <label className="text-[10px] font-black uppercase tracking-widest ml-1 text-slate-800 font-bold">
                                            ...
                                            <div
                                                ...
                                                style={{
                                                    background: resumeDrag ? "rgba(99,102,241,0.1)" : resumeFile ? "rgba(99,102,241,0.05)" : "rgba(0, 0, 0,0.02)",
                                                    border: `2px dashed ${resumeFile ? "rgba(99,102,241,0.6)" : resumeDrag ? "#818cf8" : "rgba(0, 0, 0,0.06)"}`,
                                                    minHeight: 220,
                                                }}
                                            >
                                                {resumeFile ? (
                                                    <>
                                                        ...
                                                        <div className="text-center px-4">
                                                            <p className="text-sm font-black text-slate-900 mb-1">{shortName(resumeFile.name, 28)}</p>
                                                            <p className="text-[10px] font-black text-slate-600 uppercase tracking-wider">{(resumeFile.size / 1024).toFixed(0)} KB · Ready</p>
                                                        </div>
                                                    </>
                                                ) : (
                                                    <>
                                                        ...
                                                        <div className="text-center px-4">
                                                            <p className="text-sm font-black text-slate-900 uppercase tracking-tight">Drop Resume</p>
                                                            <p className="text-[10px] mt-1 font-bold text-slate-500 uppercase tracking-widest">PDF or DOCX max 5MB</p>
                                                        </div>
                                                    </>
                                                )}
                                        ...
                                        <div className="flex flex-col gap-3">
                                            <div className="flex items-center justify-between px-1">
                                                ...
                                                <div className="flex p-0.5 rounded-xl bg-black/20 border border-black/10">
                                                    {(["paste", "upload"] as const).map(m => (
                                                        <button key={m} onClick={() => setJdMode(m)}
                                                            ...
                                                            style={{
                                                                background: jdMode === m ? "rgba(79,70,229,0.2)" : "transparent",
                                                                color: jdMode === m ? "#4f46e5" : "#475569",
                                                            }}>
                                                            {m}
                                                        </button>
                                                    ))}
                                            ...
                                            {jdMode === "paste" ? (
                                                <textarea
                                                    ...
                                                    className="rounded-3xl px-5 py-4 text-sm text-slate-900 outline-none resize-none flex-1 transition-all"
                                                    style={{
                                                ...
                                                <div
                                                    ...
                                                    className="flex flex-col items-center justify-center gap-4 rounded-3xl py-10 cursor-pointer transition-all duration-300"
                                                    style={{
                                                        background: jdDrag ? "rgba(99,102,241,0.08)" : jdFile ? "rgba(99,102,241,0.05)" : "rgba(0, 0, 0,0.02)",
                                                        border: `2px dashed ${jdFile ? "rgba(99,102,241,0.6)" : jdDrag ? "#818cf8" : "rgba(0, 0, 0,0.06)"}`,
                                                        minHeight: 220,
                                                    }}
                                                >
                                                    {jdFile ? (
                                                        <>
                                                            ...
                                                            <p className="text-sm font-black text-slate-900 px-6 text-center">{shortName(jdFile.name, 28)}</p>
                                                        </>
                                                    ) : (
                                                        <>
                                                            <div className="h-16 w-16 rounded-2xl flex items-center justify-center"
                                                            ...
                                                            <p className="text-sm font-black text-slate-900/50 uppercase tracking-tight">Upload JD</p>
                                                        </>
                                                    )}
                                    ...
                                    <button
                                        ...
                                        style={{ background: "linear-gradient(135deg, #4f46e5, #7c3aed)", boxShadow: "0 20px 40px rgba(79,70,229,0.3)" }}
                                    >
                                        {loading ? (
                                            <>
                                ...
                                <>
                                    ...
                                    <div className="flex items-center gap-6 mb-8 rounded-[2rem] px-8 py-6"
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="font-black text-slate-900 text-xl truncate mb-1">{activeResult.fileName}</p>
                                            <div className="flex flex-wrap items-center gap-3">
                                                <p className="text-[10px] font-black uppercase tracking-widest text-indigo-700">{formatDate(activeResult.createdAt)}</p>
                                                {activeResult.hasJD && (
                                        ...
                                        <button
                                            onClick={() => { setActiveResult(null); setResumeFile(null); setJdText(""); setJdFile(null); setError(""); }}
                                            className="flex-shrink-0 px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all hover:bg-black/5 active:scale-95"
                                            style={{ color: "#4f46e5", border: "1px solid rgba(79,70,229,0.3)" }}
                                        >
                                            New
                                        </button>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-4 mb-8">
                                        {[
                                            { label: "Questions", value: activeResult.qa.length, color: "#8b5cf6", icon: <HelpCircle className="h-5 w-5" /> },
                                            { label: "Topics", value: activeResult.topics.length, color: "#06b6d4", icon: <BookOpen className="h-5 w-5" /> },
                                            { label: "Resume Tips", value: activeResult.tips.length, color: "#f59e0b", icon: <Lightbulb className="h-5 w-5" /> },
                                        ].map(s => (
                                            <div key={s.label} className="group relative rounded-3xl p-6 transition-all duration-300 hover:-translate-y-1"
                                                style={{ 
                                                    background: "#ffffff", 
                                                    border: `2px solid rgba(0,0,0,0.15)`,
                                                ...
                                                <p className="text-4xl font-black mb-1.5 tracking-tighter" style={{ color: s.color }}>{s.value}</p>
                                                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-800">{s.label}</p>
                                    ...
                                    <div className="flex gap-2 p-1.5 mb-8 rounded-2xl bg-black/10 border-2 border-black/10 w-fit">
                                        ...
                                        <div className="animate-fadeIn">
                                            <div className="flex flex-wrap gap-2.5 mb-8">
                                                {categories.map(cat => (
                                                    <button key={cat} onClick={() => { setActiveCategory(cat); setExpandedQ(null); }}
                                                        className="px-5 py-2 rounded-2xl text-[10px] font-black uppercase tracking-[0.1em] transition-all duration-300 relative group overflow-hidden"
                                                        style={{
                                                            background: activeCategory === cat ? (CAT_COLORS[cat] ?? "#4f46e5") : "rgba(255,255,255,0.8)",
                                                            border: `1px solid ${activeCategory === cat ? "transparent" : "rgba(0, 0, 0,0.08)"}`,
                                                            color: activeCategory === cat ? "#000" : "#1e293b",
                                                            boxShadow: activeCategory === cat ? `0 8px 20px ${(CAT_COLORS[cat] ?? "#4f46e5")}40` : "none"
                                                        }}>
                                                        {activeCategory === cat && (
                                                            <div className="absolute inset-0 bg-white/20 transition-transform group-hover:scale-110" />
                                                        )}
                                            ...
                                            <div className="flex flex-col gap-4">
                                                {filteredQA.map((item, i) => (
                                                    <div key={i} className="rounded-2xl overflow-hidden transition-all duration-300 shadow-sm"
                                                        style={{
                                                            background: "#ffffff",
                                                            border: `2px solid ${expandedQ === i ? "rgba(99,102,241,0.5)" : "rgba(0,0,0,0.15)"}`,
                                                        }}>
                                                        <button className="w-full flex items-center justify-between px-6 py-5 text-left gap-4"
                                                            ...
                                                            <div className="flex items-center gap-4 min-w-0">
                                                                ...
                                                                <span className="text-sm font-semibold text-slate-900/90 leading-tight">{item.q}</span>
                                                            </div>
                                                            <div className="flex items-center gap-3 flex-shrink-0">
                                                                <span className="text-[10px] px-2.5 py-1 rounded-lg font-black uppercase tracking-[0.1em] transition-all"
                                                                    style={{ 
                                                                        background: `${CAT_COLORS[item.category] ?? "#4f46e5"}20`, 
                                                                        color: CAT_COLORS[item.category] ?? "#4f46e5",
                                                                        border: `1px solid ${CAT_COLORS[item.category] ?? "#4f46e5"}30` 
                                                                    }}>
                                                                    {item.category}
                                                                </span>
                                                            ...
                                                            <div className="px-6 pb-6 animate-fadeIn">
                                                                ...
                                                                <div className="flex gap-4">
                                                                    <span className="flex h-8 w-8 items-center justify-center rounded-xl text-xs font-bold flex-shrink-0 mt-0.5"
                                                                        style={{ background: "rgba(16,185,129,0.12)", color: "#047857" }}>A</span>
                                                                    <p className="text-sm font-bold leading-relaxed text-slate-900">{item.a}</p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                        ...
                                        <div className="animate-fadeIn grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            {activeResult.topics.map((topic, i) => (
                                                <div key={i} className="flex items-start gap-4 rounded-3xl p-6"
                                                    ...
                                                    <span className="flex h-8 w-8 items-center justify-center rounded-xl text-xs font-bold flex-shrink-0 mt-0.5"
                                                        style={{ background: "rgba(6,182,212,0.15)", color: "#0891b2", border: "1px solid rgba(6,182,212,0.4)" }}>{i + 1}</span>
                                                    <p className="text-sm font-bold leading-relaxed text-slate-900">{topic}</p>
                                                </div>
                                            ))}
                                        </div>
                                    )}
                                    ...
                                    {activeTab === "tips" && (
                                        <div className="animate-fadeIn">
                                            <div className="grid grid-cols-3 gap-4 mb-8">
                                                {[
                                                    { type: "strength", label: "Strengths", color: "#10b981", icon: <CheckCircle2 className="h-5 w-5" />, count: tipCount.strength },
                                                    { type: "improve", label: "Improve", color: "#f59e0b", icon: <AlertTriangle className="h-5 w-5" />, count: tipCount.improve },
                                                    { type: "missing", label: "Missing", color: "#ef4444", icon: <XCircle className="h-5 w-5" />, count: tipCount.missing },
                                                ].map(s => (
                                                    <div key={s.type} className="group relative rounded-3xl p-6 transition-all duration-300 hover:-translate-y-1"
                                                        style={{ background: "rgba(255,255,255,0.8)", border: `1px solid #fff`, boxShadow: `0 10px 30px ${s.color}10` }}>
                                                        <div className="absolute top-4 right-4 h-10 w-10 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110"
                                                            style={{ background: `${s.color}15`, color: s.color, border: `1px solid ${s.color}25` }}>
                                                            {s.icon}
                                                        </div>
                                                        <p className="text-4xl font-black mb-1.5 tracking-tighter" style={{ color: s.color }}>{s.count}</p>
                                                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-800">{s.label}</p>
                                                        <div className="mt-4 h-1 w-12 rounded-full overflow-hidden bg-slate-100">
                                                            <div className="h-full rounded-full" style={{ width: "60%", background: s.color }} />
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="flex flex-col gap-4 mb-8">
                                                {activeResult.tips.map((tip, i) => {
                                                    ...
                                                    return (
                                                        <div key={i} className="flex gap-5 rounded-3xl p-6 transition-all hover:translate-x-1 shadow-sm"
                                                            style={{ background: cfg.bg, border: `1px solid #fff` }}>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm font-bold leading-relaxed text-slate-900">{tip.text}</p>
                                                            </div>
                                                        </div>
                                                    );
                                                })}
                                            ...
                                            <div className="rounded-[2.5rem] p-10 flex flex-col md:flex-row items-center justify-between gap-8"
                                                ...
                                                <div className="text-center md:text-left">
                                                    <p className="text-xl font-bold text-slate-900 mb-2">Want a professionally rewritten resume?</p>
                                                    <p className="text-sm max-w-lg font-bold text-slate-800">
                                                ...
                                                <a
                                                    ...
                                                    className="flex-shrink-0 flex items-center gap-3 rounded-2xl px-8 py-4 text-sm font-bold text-slate-900 transition-all hover:scale-105 active:scale-95 shadow-xl"
